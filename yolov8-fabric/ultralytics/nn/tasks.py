...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, nn.Conv2d, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3, FE_C2f, DSC_C2f
             }:
            ...
            if m in (DySnakeConv,):
                c2 = c2 * 3
            if m in {BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, FE_C2f, DSC_C2f}:
            ...
            args.insert(1, [ch[x] for x in f])
                   ...
                   TripletAttention, CoordAtt, CBAM, BAMBlock, LSKBlock, SEAttention, CPCA, Partial_conv3}:
            c2 = ch[f]
            args = [c2, *args]
            # print(args)
